...
session capture. The existing LaunchControl XL playground proves
...
multi-lane songs, audio sample decoding/rendering, per-pattern sample
triggering, script-bound lane actions, audio-affecting pattern-bank selection,
